...
export default function useShouldShowAds(hasPremiumPlus: boolean, doSetAdBlockerFound: (boolean) => void) {
  ...
  function resolveAdVisibility() {
    ...
    return ad_blocker_detected === false && SHOW_ADS && !hasPremiumPlus;
  }
